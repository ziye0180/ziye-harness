...
export const zh = {
  ...
  'row.failed': '失败',
  'row.stopped': '已停止',
  'tool.activity.completed.one': '执行了 1 项操作',
  'tool.activity.completed.many': '执行了 {count} 项操作',
  'tool.activity.running.one': '正在执行 1 项操作',
  'tool.activity.running.many': '正在执行 {count} 项操作',
  'tool.activity.failed.one': '1 项操作失败',
  'tool.activity.failed.many': '{count} 项操作中有失败',
  'tool.activity.stopped.one': '已停止 1 项操作',
  'tool.activity.stopped.many': '已停止 {count} 项操作',
  'queue.count': '{n} 条排队消息',
  'queue.edit': '编辑排队消息',
...
export const en = {
  ...
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
  'tool.activity.completed.one': 'Ran 1 tool call',
  'tool.activity.completed.many': 'Ran {count} tool calls',
  'tool.activity.running.one': 'Running 1 tool call',
  'tool.activity.running.many': 'Running {count} tool calls',
  'tool.activity.failed.one': '1 tool call failed',
  'tool.activity.failed.many': '{count} tool calls with failures',
  'tool.activity.stopped.one': 'Stopped 1 tool call',
  'tool.activity.stopped.many': 'Stopped {count} tool calls',
