...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Document-title owner; an occupant replaces the build-selected product title projection. */
    'shell.document-title': { kind: 'single'; scope: 'root'; owner: DocumentTitleOwnerProps }
  }
}
...
/** Document title owner share supplied by the root frame. */
export interface DocumentTitleOwnerProps {
  /** Durable selected-session title, or undefined for the product title alone. */
  title?: string
}
