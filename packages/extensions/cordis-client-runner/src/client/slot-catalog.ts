...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation DefaultHeroBrand',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The visual identity inside the sidebar\'s existing buttons.',
    doc: 'The visual identity inside the sidebar\'s existing buttons. The shell\nretains click and collapse behavior; an occupant renders either the\nexpanded wordmark or the collapsed mark from SidebarBrandOwnerProps.\nThe package registers the product default at priority 0, so a lower-\npriority skin can replace it and disposal reveals the default again.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-ui-sidebar DefaultSidebarBrand',
    ],
    replaceRisk: 'shadows-shipped-ui',
